"""제출 sub_018: sub_017 + FICR 가중 보정 a_bar×0.7 (실험 #54 — 밴드확률 과소평가 ~4%p 교정).
...
def main() -> None:
    ...
    for tgt in TARGET_COLS:
        ...
        out[tgt] = optimize_submission(atoms, cap, a_bar * 0.7)  # FICR 가중 보정 (#54)
    ...
    path = PROJECT / "submissions" / "sub_018_ficr_alpha.csv"
