"""제출 sub_016: sub_013 + base GBM 정칙화 강화 (v24 reg: CV +0.0052, 6/6 fold — 실험 #52).
...
def main() -> None:
    ...
    qmodels = [lgb.LGBMRegressor(objective="quantile", alpha=q, **REG_PARAMS)
    ...
    path = PROJECT / "submissions" / "sub_016_regularized.csv"
