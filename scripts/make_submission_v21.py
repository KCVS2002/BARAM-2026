"""제출 sub_021: sub_020 + IFS wave-2 물리 5피처 (실험 #66 v31b/c: CV +0.0057 6-fold 전승,
FICR +0.0099). main GBM에만 ifs_t925/ifs_dt/ifs_ws700/ifs_shear/ifs_q850 추가 — 안정도·시어·습도.
...
def main() -> None:
    ...
    path = PROJECT / "submissions" / "sub_021_phys5.csv"
