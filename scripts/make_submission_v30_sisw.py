"""제출 sub_030: sub_029(공식) + g3 OM sister에도 q3 가중 (실험 #86 v52: 홀드아웃
g3 +0.0048, FICR +0.0104/NMAE -0.0007 — main 가중과 동일 시그니처). sister 학습
가중에 ×(1+3·cf²) 적용, 그 외 전 구조 불변 (g1/g2 무변경).
...
def main() -> None:
    ...
    for tgt in TARGET_COLS:
        ...
        sw.append(weights_main.loc[trm.to_numpy(), tgt])
    ...
    path = PROJECT / "submissions" / "sub_030_sisw.csv"
