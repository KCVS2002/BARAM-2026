"""제출 sub_026: sub_025 + g3 sister 조건부 (실험 #78 v46: 홀드아웃 g3 +0.0018, FICR +0.0042).

sub_025(공식)와 동일하되, g3 OM sister 원자 수를 d̄ 3분위로 조건부화:
멂(희귀) 175 / 중간 150 / 가까움 125 — inv_soft와 동일 문법의 sister 확장.
희귀 레짐에서 '다른 NWP 관점'의 몫을 늘린다. 나머지 전 구조 불변.
...
def main() -> None:
    ...
    path = PROJECT / "submissions" / "sub_026_siscond.csv"
