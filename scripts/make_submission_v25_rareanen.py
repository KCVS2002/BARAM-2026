"""제출 sub_025: sub_021 + 희귀 레짐 AnEn 증량 inv_soft (실험 #77 v45: CV +0.0027).

아날로그 평균거리 d̄의 3분위(예측 집합 자체 기준 — 2024 상수 아님)로 원자 재배분:
멂(희귀 레짐) anen175+gbm125 / 중간 150+150 / 가까움 anen125+gbm175.
근거: 흔한 레짐에선 GBM 우세, AnEn의 실측 분포 가치는 희귀 레짐에서 발생 (#57 대조군
발견 → v45 재현). g3 부가 원자(가용률 혼합·OM sister)와 결정 배깅은 불변.
...
def main() -> None:
    ...
    path = PROJECT / "submissions" / "sub_025_rareanen.csv"
